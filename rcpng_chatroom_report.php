...
$stats = [
    ['label' => 'Active Workrooms', 'value' => '7'],
    ['label' => 'Alerts', 'value' => '4'],
    ['label' => 'Resolved', 'value' => '3'],
    ['label' => 'Pending', 'value' => '1'],
];
$items = [
    ['label' => 'Site Safety', 'value' => 'Normal'],
    ['label' => 'Maintenance Chats', 'value' => 'Active'],
    ['label' => 'Vehicle Reports', 'value' => 'Logged'],
    ['label' => 'Emergency Updates', 'value' => 'Ready'],
];
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container report-shell">
        ...
        <div class="dashboard-card">
            ...
            <form class="report-form" method="POST" action="submit_report.php">
                <input type="hidden" name="room" value="RPNGC">
                <div class="form-group">
                    <label for="room-name">Room / Chat ID</label>
                    <input id="room-name" type="text" value="RPNGC Workroom 03" readonly>
                </div>
                <div class="form-group">
                    <label for="report-message">Issue Details</label>
                    <textarea id="report-message" name="message" rows="5" placeholder="Describe site issue, daily activity, or safety concern..."></textarea>
                </div>
                <div class="form-actions">
