...
<head>
    ...
    <title>Staff Dashboard | MoWLiSS</title>
...
<div class="container">
    ...
    <div class="dashboard-card">
        <h2>Welcome, <?= e($_SESSION['user_name'] ?? 'Staff') ?></h2>
        <p class="small">You are logged in as Staff.</p>
    </div>

    <?php require_once __DIR__ . '/dashboard_chatrooms.php'; render_dashboard_chatrooms('staff'); ?>
